...
export function DanielPage() {
  ...
  return (
    <article ref={root} className="bg-ink">
      <div className="relative lg:grid lg:min-h-dvh lg:grid-cols-12">
        <figure className="daniel-portrait relative h-[72vh] overflow-hidden lg:absolute lg:inset-y-0 lg:right-0 lg:left-[28%] lg:h-full lg:w-auto">
          <Image
            ...
            className="daniel-still object-cover object-[center_14%] saturate-[0.88] lg:object-[62%_14%]"
          />
          <div
          ...
          />
          <div
            className="pointer-events-none absolute inset-0 bg-gradient-to-r from-ink via-ink/75 to-transparent lg:from-ink lg:via-ink/20 lg:to-transparent"
            aria-hidden
          />
          <div
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_70%_at_70%_38%,transparent_0%,#0c0b0a_100%)] opacity-90 lg:bg-[radial-gradient(ellipse_65%_60%_at_58%_40%,transparent_0%,#0c0b0a_100%)]"
            aria-hidden
          />
        </figure>

        <div className="relative z-10 flex flex-col justify-end px-5 pt-10 pb-20 lg:col-span-5 lg:col-start-1 lg:justify-center lg:px-10 lg:py-32 xl:col-span-4">
